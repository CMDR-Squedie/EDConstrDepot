...
You can also manage all your visited markets and constructions in one place using the **Manage All** command. This tool lets you filter data, quickly set active market or construction, ignore selected markets etc.
