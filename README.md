...
Indicators:<br>
□/■ - commodity available at current (or recent) market; partial/full supply*<br>
∆/▲ - commodity available at secondary market (user selected); partial/full supply*<br>
○/● - commodity available at best market (auto-selected, see below); partial/full supply*<br>
(no indicators) - commodity in cargo, exact match with construction request or ship capacity<br>
≠ - commodity in cargo, hauling more than requested<br>
< - commodity in cargo, hauling less then requested and under ship capacity<br>
