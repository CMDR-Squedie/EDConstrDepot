...
Advanced Features (.ini file only):
 ...
 - the app can auto-suggest best market for construction request with its own indicator. Use **ShowBestMarket** to test it (very experimental, megaships are excluded)
